...
# export PATH=/scratch/midway2/chaodai/miniconda3/bin:/scratch/midway2/chaodai/miniconda3/condabin:/home/chaodai/bin:/home/chaodai/.local/bin:$PATH
...
module load tmux/3.1c gsl/2.5 parallel

# Path to your oh-my-zsh installation.
export ZSH="$HOME/.oh-my-zsh"

# export FZF_BASE=/scratch/midway2/chaodai/miniconda3/share/fzf
...
ZSH_THEME="bira"
# NOTE!!! modified custom plugin for virtual env and the bira theme for conda
...
plugins=(git virtualenv zsh-syntax-highlighting zsh-autosuggestions z fzf)
...
# zsh auto-complete
# doesn't work on midway2, probably because zsh version is too low
